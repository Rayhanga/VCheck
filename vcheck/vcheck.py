...
class VCheck():
    ...
    def login(self, uname, pwd):
        ...
        self.auth = scrapper.getLoginInfo(self.driver.page_source)
    ...
    def getUpcomingTasks(self):
        if self.auth:
            ...
            return scrapper.getUpcomingTask(self.driver.page_source)
    ...
    def getCourseList(self):
        if self.auth:
            ...
            return scrapper.getCourseList(self.driver.page_source)
